...
public class LoginPageTest_08_AllwithLoggerandListeners extends CommonToAllTests {
    //create an instance for logger

    private static final Logger logger = LogManager.getLogger(LoginPageTest_08_AllwithLoggerandListeners.class.getName());
